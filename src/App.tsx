...
export default function App() {
  const { ref: heroRef, animationClass: heroAnim } = useInViewAnimation();
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-[#FF6B00] selection:text-white">
      ...
      <section className="flex flex-col items-center pt-12 md:pt-16 px-6">
        ...
        >
          ...
          >
            <Button className="w-full sm:w-auto text-lg px-10 py-5">👉 QUERO RECOMEÇAR AGORA</Button>
          </motion.div>
        </motion.div>
      </section>
      ...
      {/* 4. VIRADA + APRESENTAÇÃO */}
      <TestimonialSection />

      {/* 5. O QUE É O MÉTODO + BENEFÍCIOS */}
      <ProjectsSection />
